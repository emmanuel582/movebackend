-- ============================================
-- COMPLETE FIX - ALL ISSUES (RUN THIS ONE!)
-- ============================================
-- This single script fixes:
-- 1. Registration failures (trigger + RLS)
-- 2. Phone number conflicts
-- 3. Admin dashboard (can see all users/verifications)
...
FROM pg_policies 
WHERE roles::text[] @> ARRAY['service_role']
ORDER BY tablename, policyname;

SELECT '========================================' as separator;
SELECT '✅ USER POLICIES CREATED' as status;
SELECT '========================================' as separator;

SELECT tablename, policyname, cmd
FROM pg_policies 
WHERE roles::text[] @> ARRAY['authenticated']
ORDER BY tablename, policyname;

SELECT '========================================' as separator;
SELECT '✅ DATABASE STATS' as status;
SELECT '========================================' as separator;
